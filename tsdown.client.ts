 ...
 *
 * Standalone port of the official preset in the deepseek-harness checkout
 * (packages/client/tsdown.client.ts): the platform module list is inlined
 * below (mirroring packages/client/web/src/platform.ts) and REPOSITORY_ROOT
 * points at this package so sourcemaps carry package-relative paths.
 */
 ...
 * kernel generations — 0.1.2-rc.1, 0.1.3-alpha.2 and 0.1.5-alpha.1/alpha.2/rc.1/rc.2 and 0.1.6-alpha.1/alpha.2 (react family +
